...
<!--        <hr>-->
        <section class="sub_header">
            ...
            <p>На данной странице реализована возможность пройти тестирование по предмету "Экономика предприятия". На прохождение теста отведено 80 минут с момента загрузки страницы с вопросами теста. Тест пройти можно только один раз. Для того чтобы приступить к тестированию необходимо ввести ваши регистрационные данные и нажать кнопку "Приступить", после чего откроется страница с тестами. По окончанию 80 минут ваш тест будет автоматически отправлен на проверку даже если вы его не окончили.</p>
        </section>
    </header>
